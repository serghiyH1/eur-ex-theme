	...
	<header class="entry-header page-content-section bg-cover" <?php if ( $featured_img_url ): ?>style="background-image: url(<?php echo $featured_img_url; ?>)"<?php endif; ?>>
		<div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-6 col-xl-5 <?php if ( $featured_img_url ): ?>c-white<?php endif; ?>">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-6 col-xl-5">
                    <form action="<?php echo $current_url; ?>" id="tracking-form" class="tracking-form">
                        <input type="text" id="tracking-number" class="tracking-number" placeholder="<?php echo pll__( 'Введіть трекінг номер' ); ?>">
                        <input type="submit" id="tracking-submit" class="tracking-submit" value="<?php echo pll__( 'Перевірити' ); ?>">
                    </form>
                </div>
            </div>
        </div>
